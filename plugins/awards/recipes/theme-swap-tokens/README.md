...
## Why
- **Colour as page state** is the corpus's cheapest large move: four named themes swapped per section `[site:leo-parpeix]`, a background tweened per route `[site:floema-jewelry]`, a colour field bound to the product `[site:slosh-seltzer]` (`[pattern:color-and-material#colour-as-state]`).
...
Seen in: `[site:leo-parpeix]`, `[site:floema-jewelry]`, `[site:slosh-seltzer]`, `[site:shopify-editions-w26]`, `[site:lando-norris]`.
