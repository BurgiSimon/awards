...
| siena | https://siena.film/ | added | D 7.8 / U 5.8 / C 8.0 / Co 7.2 → w 7.18 [inferred]; official: SOTD 18 Mar 2025, 7.9 (D 7.99 / U 7.61 / C 8.13 / Co 8), Dev 7.51 (Sem 7.20, Anim 8.60, A11y 6.60, WPO 7.20, Resp 8.00, Markup 7.20) [verified, entry page] | technique: film-strip roll drawn in GL, with the frame shape cut by a mask texture, colour-dodge toward gold in the corners and velocity blur on the DOM layer — checked against recipe gl-dom-tethered-planes and pattern components-catalog#filmstrip-project-rows; technique: tutorial overlay on first visit (demo video, captions stepped every 4.8 s, 48 h cookie) — checked against preloaders-and-transitions#preloader-archetypes; stack: OGL — checked against stacks/three-0.186.md; stack: @unseenco/taxi — checked against recipe page-transitions (no stack note); stack: virtual-scroll package — checked against stacks/lenis-1.3.md | |  | 2026-09-23 |
